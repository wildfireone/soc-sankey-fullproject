 ...
 * @Last modified time: 28-Sep-172017
 */
        ...
        relations.forEach(function (s){
          ...
          s.values.forEach(function (t){
            ti = getNodeIndex(n, t.key, tg)
						cidx = 		t.values[0]["chash"];
						pidx = 		t.values[0]["phash"];
						vidx = 		t.values[0]["vhash"];
						lidx = 		t.values[0]["id"];
						multi =	 	t.values[0]["multi"];
						vcount = 	t.values[0]["voyageCount"];
            ...
            var link = { source : n[si], target : n[ti], value : value, cidx : cidx, pidx : pidx, vidx:vidx, lidx:lidx, multi:multi, vcount:vcount};
